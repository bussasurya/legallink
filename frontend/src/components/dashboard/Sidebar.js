...
const icons = {
    ...
    meetings: (color) => <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill={color}><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zM7 12h5v5H7v-5z"/></svg>,
    // This icon was missing from your file but is needed for the lawyer
...
const Sidebar = ({ isToggled, setToggled }) => {
    ...
    const sidebarStyle = {
        ...
        // --- CRITICAL FIX: Makes the sidebar stay in place ---
        position: 'sticky',
        top: '74px', // This must match your Navbar's height
        height: 'calc(100vh - 74px)', // Fill the remaining height
        overflowY: 'auto'
    };
    ...
    const toggleButtonStyle = {
        position: 'fixed', // Fixed so it floats over the content
        top: '90px', // Aligned with the top of the sidebar
        left: isToggled ? '65px' : '235px', // Moves with the sidebar
        width: '30px',
        height: '30px',
        borderRadius: '50%',
